...
DEFAULT_KPI_METADATA: dict[str, dict[str, Any]] = {
    ...
    "NPL": {
        "formula": "SUM(principal_balance WHERE dpd >= 30) / SUM(principal_balance) * 100",
        "definition": "Non-Performing Loan ratio (broad): balance-weighted 30+ DPD exposure.",
        "implications": "Tracks early non-performance pressure; pair with PAR90 and default_rate for severity.",
    },
    "LGD": {
