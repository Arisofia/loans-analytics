...
class TestCalculateRecurrentTpv:
    ...
    def test_second_period_recurrent_and_new(self):
        ...
        assert feb['recurrent_clients'] == 1
        assert feb['new_clients'] == 1
    ...
    def test_third_period_recovered(self):
        ...
        assert mar['recurrent_clients'] == 2
        assert mar['recovered_clients'] == 1
        assert mar['new_clients'] == 0
        assert mar['tpv_recurrent'] == pytest.approx(180.0)
        assert mar['tpv_recovered'] == pytest.approx(80.0)
