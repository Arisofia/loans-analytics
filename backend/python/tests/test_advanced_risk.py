"""Tests for advanced risk KPI calculations and API service integration."""
        ...
        self.df = pd.DataFrame(
            {
                ...
                "days_past_due": [0, 45, 75, 120],
                "principal_balance": [100.0, 200.0, 300.0, 400.0],
                "loan_amount": [120.0, 220.0, 320.0, 420.0],
                "interest_rate": [0.1, 0.2, 0.3, 0.4],
                "origination_fee": [1.0, 2.0, 3.0, 4.0],
                "origination_fee_taxes": [0.1, 0.2, 0.3, 0.4],
                "last_payment_amount": [10.0, 20.0, 30.0, 40.0],
                "total_scheduled": [20.0, 40.0, 60.0, 80.0],
                "recovery_value": [0.0, 0.0, 0.0, 50.0],
