...
class TestStrategicReporting(unittest.TestCase):
    ...
    def test_writes_report_artifacts_and_contains_links(self):
        ...
        links = {'streamlit_local': 'http://localhost:8501', 'grafana_local': 'http://localhost:3001/dashboards', 'streamlit_prod': 'https://abaco-analytics-dashboard.azurewebsites.net', 'dashboard_docs': 'docs/analytics/dashboards.md'}
