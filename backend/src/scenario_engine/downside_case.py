"""Downside-case scenario — moderate adverse conditions.

Models a credit deterioration with higher delinquency, lower origination,
...
def run(current_metrics: Dict[str, Any]) -> ScenarioResult:
    """Project metrics under downside assumptions."""
