...
def _sample_realtime_payload() -> dict:
    return {'loans': [{'id': 'L1', 'loan_amount': 1000.0, 'principal_balance': 1000.0, 'interest_rate': 0.1, 'loan_status': 'current', 'total_scheduled': 100.0, 'last_payment_amount': 80.0}, {'id': 'L2', 'loan_amount': 1000.0, 'principal_balance': 1000.0, 'interest_rate': 0.2, 'loan_status': '90+ days past due', 'total_scheduled': 150.0, 'last_payment_amount': 75.0}]}
