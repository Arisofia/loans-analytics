...
class TestCashBalanceTreasury(unittest.TestCase):
    ...
    def test_returns_ok_status(self):
        from backend.loans_analytics.kpis.lending_kpis import cash_balance_treasury
    ...
    def test_treasury_not_provided_when_no_cash_balance(self):
        from backend.loans_analytics.kpis.lending_kpis import build_lending_kpi_report
...
class TestCollectionEfficiency6M(unittest.TestCase):
    ...
    def test_full_collection_returns_100_pct(self):
        ...
        from backend.loans_analytics.kpis.lending_kpis import collection_efficiency_6m
...
class TestSLATargets(unittest.TestCase):
    ...
    def test_target_mode_returns_targets(self):
        from backend.loans_analytics.kpis.lending_kpis import sla_targets
        r = sla_targets()
        self.assertEqual(r['status'], 'ok')
...
class TestFinancingRateEIR(unittest.TestCase):
    ...
    def test_weighted_apr_computed(self):
        from backend.loans_analytics.kpis.lending_kpis import financing_rate_eir
...
class TestCostOfDebtDSCR(unittest.TestCase):
    ...
    def test_dscr_above_target(self):
        from backend.loans_analytics.kpis.lending_kpis import cost_of_debt_dscr
