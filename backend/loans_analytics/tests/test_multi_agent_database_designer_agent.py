...
from backend.loans_analytics.multi_agent.specialized_agents import DatabaseDesignerAgent

class TestDatabaseDesignerAgent(unittest.TestCase):

    def setUp(self) -> None:
        self._init_client_patcher = patch('backend.loans_analytics.multi_agent.base_agent.BaseAgent._init_client')
