...
from backend.loans_analytics.multi_agent.orchestrator.decision_orchestrator import (  # noqa: F401
...
def _load_legacy_orchestrator() -> types.ModuleType:
    ...
    spec = importlib.util.spec_from_file_location(
        "backend.loans_analytics.multi_agent._legacy_orchestrator", str(legacy_path)
    )
