...
class CollectionsAgent(BaseAgent):
    ...
    def get_system_prompt(self) -> str:
        ...
        return (
            ...
            "high-risk accounts\n"
            "- Measuring efficiency using the Cure Rate (% of delinquent loans "
            "returning to current status)\n"
            "- Segmenting borrowers by delinquency stage (30/60/90+ days "
            "past due) and intensity levels\n"
            "- Recommending collection strategies based on DPD Migration logic: "
            "SMS/calls for 1-30, formal notice for 31-60, and legal/field team "
            "for 61-90 DPD\n"
            ...
            "2. Prioritize high-exposure accounts in the 31-60 DPD window to "
            "prevent roll-forward to NPL status\n"
            "3. Evaluate the Cure Rate to determine strategy effectiveness\n"
            "4. Recommend tiered collection strategies (soft touch -> "
            "aggressive)\n"
...
class PricingAgent(BaseAgent):
    ...
    def get_system_prompt(self) -> str:
        ...
        return (
            ...
            "3. Optimize NIM to ensure it covers operational expenses and "
            "equity returns\n"
            "4. Model expected defaults and losses at different rate "
            "levels\n"
            "5. Recommend tiered pricing for different risk segments\n"
            "6. Balance short-term revenue with long-term portfolio "
            "quality\n\n"
            "Always provide pricing recommendations with expected "
            "profitability metrics (NIM, CoR), conversion impact, and "
            "competitive positioning."
        )
