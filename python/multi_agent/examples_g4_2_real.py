...
def run_example(kpi_id: str = "npl_ratio") -> None:
    ...
    try:
        ...
        print("\nTroubleshooting:")
        if mode == "REAL":
            print("  - Check SUPABASE_URL and SUPABASE_ANON_KEY env vars are set")
            print("  - Verify historical_kpis table exists in Supabase")
            print("  - Ensure firewall allows outbound HTTPS to Supabase")
        else:
            print("  - Check MOCK mode synthetic data is loaded")
        print("=" * 70 + "\n")
        raise
