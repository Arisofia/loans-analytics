"""LanguageModel Provider - Unified interface for OpenAI and Anthropic.

This module provides a unified interface for interacting with multiple LanguageModel providers,
...
class LanguageModelProvider(Enum):
    """Supported LanguageModel providers."""
...
class LanguageModelResponse:
    """Standardized LanguageModel response format."""
...
class BaseLanguageModelProvider(ABC):
    """Abstract base class for LanguageModel providers."""

    @abstractmethod
    def complete(self, messages: List[Dict], **kwargs) -> LanguageModelResponse:
...
class LanguageModelManager:
    """Manager for multiple LanguageModel providers with fallback support."""
    ...
    def __init__(
        ...
        logger.info(
            "Initialized LanguageModel Manager with providers: %s",
    ...
    def complete(
        ...
        if provider_name == "openai" and OPENAI_AVAILABLE and openai is not None:
        ...
        raise RuntimeError("All LanguageModel providers failed or unavailable")
