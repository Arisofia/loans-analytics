  ...
  return (
    <div className={styles.page}>
      ...
      <main id="main-content">
        <header className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.subtitle}>
              Abaco pairs portfolio intelligence with risk orchestration so finance leaders can
              scale funding confidently.
            </p>
        ...
        <section className={styles.section} id="kpis" aria-labelledby="kpis-heading">
          <div className={styles.sectionHeader}>
            <div>
              <p className={styles.eyebrow}>Portfolio KPIs</p>
              <h2 id="kpis-heading" className={styles.sectionTitle}>
                Risk-aware growth signals
              </h2>
            </div>
            <p className={styles.sectionSubhead}>
              Metrics calibrated for underwriting rigor, investor readiness, and day-to-day
              operating cadence.
            </p>
          </div>
        ...
        <section className={styles.section} id="products" aria-labelledby="products-heading">
          <div className={styles.sectionHeader}>
            ...
            <h2 id="products-heading" className={styles.sectionTitle}>
              Designed for resilient lending
            </h2>
          </div>
        ...
        <section className={styles.section} id="dashboards" aria-labelledby="dashboards-heading">
          <div className={styles.sectionHeader}>
            <p className={styles.eyebrow}>Dashboards</p>
            <h2 id="dashboards-heading" className={styles.sectionTitle}>
              Operational intelligence in one view
            </h2>
          </div>
        ...
        <section className={styles.section} id="compliance" aria-labelledby="compliance-heading">
          <div className={styles.sectionHeader}>
            <p className={styles.eyebrow}>Governance</p>
            <h2 id="compliance-heading" className={styles.sectionTitle}>
              Controls that keep auditors confident
            </h2>
          </div>
