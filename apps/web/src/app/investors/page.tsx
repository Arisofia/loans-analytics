  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <p className="mb-6 text-gray-600 text-center">
        Yield, AUM, and portfolio performance KPIs. Click any card for full traceability and
        drill-down.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="border rounded p-4 bg-white shadow hover:shadow-lg transition">
          ...
          <Link href="/kpi/investor_yield" className="text-blue-600 hover:underline">
            View Details
          </Link>
        </div>
        ...
        <div className="border rounded p-4 bg-white shadow hover:shadow-lg transition">
          ...
          <div className="mb-2 text-xs text-gray-500">Owner: Investors</div>
          <Link href="/kpi/aum" className="text-blue-600 hover:underline">
            View Details
          </Link>
        </div>
        ...
        <div className="border rounded p-4 bg-white shadow hover:shadow-lg transition">
          ...
          <div className="mb-2">
            <b>Latest:</b> +1.2% vs. benchmark
          </div>
          <div className="mb-2 text-xs text-gray-500">Owner: Investors</div>
          <Link href="/kpi/portfolio_performance" className="text-blue-600 hover:underline">
            View Details
          </Link>
        </div>
      </div>
