...
export default function TechDashboard() {
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <p className="mb-6 text-gray-600 text-center">System uptime, deployment, and incident KPIs. Click any card for full traceability and drill-down.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="border rounded p-4 bg-white shadow hover:shadow-lg transition">
          ...
          <div className="mb-2"><b>Latest:</b> 14</div>
          <div className="mb-2 text-xs text-gray-500">Owner: Tech</div>
          <Link href="/kpi/deployment_frequency" className="text-blue-600 hover:underline">View Details</Link>
        </div>
        {/* Incident MTTR KPI */}
        <div className="border rounded p-4 bg-white shadow hover:shadow-lg transition">
          ...
          <div className="mb-2"><b>Latest:</b> 42 min</div>
          <div className="mb-2 text-xs text-gray-500">Owner: Tech</div>
          <Link href="/kpi/incident_mttr" className="text-blue-600 hover:underline">View Details</Link>
        </div>
      </div>
