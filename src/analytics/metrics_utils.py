...
ANALYTICS_NUMERIC_COLUMNS = [
    "loan_amount", "appraised_value", "monthly_debt", "borrower_income",
    "principal_balance", "interest_rate", "ltv_ratio", "dti_ratio"
]
REQUIRED_ANALYTICS_COLUMNS = [
    "loan_amount", "appraised_value", "monthly_debt", "borrower_income",
    "principal_balance", "interest_rate", "loan_status"
]
