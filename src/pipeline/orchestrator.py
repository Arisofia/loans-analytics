...
class UnifiedPipeline:
    ...
    def execute(
        ...
        try:
            ...
            phase2_results = self.transformation.execute(raw_data_path=raw_data_path, run_dir=run_dir)
            ...
            phase3_results = self.calculation.execute(clean_data_path=clean_data_path, run_dir=run_dir)
            ...
            logger.info("=" * 80)
            phase4_results = self.output.execute(kpi_results=phase3_results.get("kpis", {}), run_dir=run_dir)
