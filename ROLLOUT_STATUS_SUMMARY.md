...
**Core Infrastructure:**
1. `python/kpis/base.py` - 82 lines
2. `python/pipeline/orchestrator.py` - 205 lines
3. `python/kpi_engine_v2.py` - 101 lines
4. `python/pipeline/calculation_v2.py` - 68 lines
...
1. `python/kpis/par_30.py` - Consistent interface
2. `python/kpis/par_90.py` - Consistent interface
3. `python/kpis/collection_rate.py` - Consistent interface
4. `python/kpis/portfolio_health.py` - Consistent interface
