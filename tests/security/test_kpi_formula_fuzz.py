...
def _sample_df() -> pd.DataFrame:
    return pd.DataFrame({'origination_date': ['2025-01-01', '2025-01-10', '2025-02-05', '2025-02-12'], 'outstanding_balance': [1000.0, 500.0, 1200.0, 800.0], 'status': ['Current', 'Current', 'Late', 'Current'], 'loan_id': ['L1', 'L2', 'L3', 'L4']})
_finite_float = st.floats(min_value=-1000000, max_value=1000000, allow_nan=False, allow_infinity=False)
