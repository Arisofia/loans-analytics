...
from scripts.import_notion_metrics import (
    calcular_estadisticas_metricas,
    extraer_propiedades_fila,
    main,
)
...
class TestImportNotionMetrics(unittest.TestCase):
    ...
    def test_main_success(self, mock_client_cls):
        ...
        mock_client.query_database.return_value = [
            {"id": "1", "properties": {"Visualizaciones": {"type": "number", "number": 100}}}
        ]
