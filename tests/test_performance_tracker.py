...
def test_performance_metric_to_dict():
    metric = PerformanceMetric(operation_name='test_op', duration_ms=100.5, success=True, agent_name='test_agent', scenario_name='test_scenario')
    d = metric.to_dict()
...
def test_get_latency_percentiles():
    tracker = PerformanceTracker()
    metrics = [PerformanceMetric('op', 10.0, True), PerformanceMetric('op', 20.0, True), PerformanceMetric('op', 30.0, True), PerformanceMetric('op', 40.0, True), PerformanceMetric('op', 50.0, True)]
