...
class TestAnalyticsAgent:
    ...
    def test_portfolio_analysis(self, sample_portfolio_data):
        ...
        agent = MagicMock()
        agent.analyze_portfolio.return_value = {
    ...
    def test_kpi_calculation(self):
        ...
        agent = MagicMock()
        agent.calculate_kpis.return_value = {
            "par30": 0.02,
            "par90": 0.01,
    ...
    def test_large_dataset_analysis(self):
        """Test analysis of large datasets within timeout."""
        agent = MagicMock()
        agent.analyze_large_dataset.return_value = {
            "status": "success",
