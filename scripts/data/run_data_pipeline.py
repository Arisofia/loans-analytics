...
from backend.loans_analytics.logging_config import get_logger, init_sentry  # noqa: E402
...
def run_pipeline_and_report(args) -> None:
    """Run UnifiedPipeline and print a human-readable summary, then exit with proper code."""
