...
<<<<<<< HEAD
            ...
            export_button = await self.page.wait_for_selector(
                'button:has-text("Export"), a:has-text("Export")', timeout=10000
            )
            ...
            async with self.page.expect_download() as download_info:
                ...
                csv_button = await self.page.wait_for_selector(
                    'text="CSV", button:has-text("CSV")', timeout=5000
                )
...
<<<<<<< HEAD
            ...
            # Look for Export button
            export_button = await self.page.wait_for_selector(
                'button:has-text("Export")', timeout=10000
            )

            # Set up download handler
            async with self.page.expect_download() as download_info:
                await export_button.click()
                csv_button = await self.page.wait_for_selector('text="CSV"', timeout=5000)
                await csv_button.click()
...
async def main():
    ...
    # Parse arguments
<<<<<<< HEAD
    parser = argparse.ArgumentParser(description="Automate Cascade Debt data downloads")
    parser.add_argument("--loan-tape", action="store_true", help="Download loan tape export")
    parser.add_argument("--financials", action="store_true", help="Download financial statements")
