...
def validate_active_folders(structure: Dict, repo_root: Path, verbose: bool = False) -> Tuple[List, List]:
...
def validate_config_files(structure: Dict, repo_root: Path, verbose: bool = False) -> Tuple[List, List]:
...
def validate_archive_structure(structure: Dict, repo_root: Path, verbose: bool = False) -> Tuple[List, List]:
