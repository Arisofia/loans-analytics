#!/usr/bin/env python3
"""Train and persist the default-risk XGBoost model for API inference.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("models/risk"),
        help="Directory where model and metadata are written",
    )
    parser.add_argument(
        "--exclude-days-past-due",
        action="store_true",
        help="Exclude days_past_due feature for origination-only scoring",
    )
