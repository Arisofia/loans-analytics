...
def test_usage_tracker():
    ...
    tracker.export(exports_dir / "usage.json", format="json")
    tracker.export(exports_dir / "usage.csv", format="csv")
    tracker.export(exports_dir / "usage.parquet", format="parquet")
