...
> **⚠️ Historical Document – Cascade Integration Retired (2026-01)**
>
> This plan references the Cascade API which has been fully deprecated.
> **Current data ingestion:** CSV files or direct Supabase queries.
> The pipeline architecture remains valid; only the ingestion source has changed.

## Purpose and scope

This document consolidates the end-to-end audit scope and defines the execution plan to deliver a single, deterministic, production-grade pipeline for data ingestion → analytics distribution. It emphasizes automation, observability, and configuration-driven design to eliminate manual steps and fragmentation.
