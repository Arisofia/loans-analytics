...
3. **Streamlit pipeline**
   ...
   - **Export prep**: create flattened fact tables that list dimensions and metrics, ready for export. Provide widgets to refresh ingestion without restarting the runtime.
