...
When adding or updating automation, keep one canonical command/script per task and update
`docs/operations/SCRIPT_CANONICAL_MAP.md` instead of adding parallel alternatives.
