...
- Front-end + CRM/backoffice operational by Dec-25 (CRM + customer portal).
...
- Week 2: pilot Taktile scoring, set up CRM tooling, hire KAMs (1→4), launch digital campaigns, sign embedded ISV partnerships, deploy weekly dashboard.
