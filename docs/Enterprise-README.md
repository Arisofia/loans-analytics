...
- **Repo protections**: branch protections with 2 reviewers, required checks (`CI`, `codeql`, `sonarcloud`), signed commits, linear history, and **CODEOWNERS** for API/service paths. Mark CodeQL and CI as **required workflows** on `main`.
