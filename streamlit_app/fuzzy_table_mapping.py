    ...
    for name, df in dfs.items():
        ...
        if isinstance(df, dict):
            ...
            for sheet, sdf in df.items():
                ...
                if ("loan" in sheet_lower and "data" in sheet_lower) or sheet_lower.startswith("loans"):
                    mapped_dfs["loan_data"] = sdf
                elif ("customer" in sheet_lower and "data" in sheet_lower) or sheet_lower.startswith("customer"):
                    mapped_dfs["customer_data"] = sdf
                elif ("payment" in sheet_lower and "historic" in sheet_lower) or ("real" in sheet_lower and "payment" in sheet_lower) or sheet_lower.startswith("transaction"):
