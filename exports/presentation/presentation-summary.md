...
- **Theme:** Dark gradients with neon purple/blue accents to mirror the "Dark Editable Slides".
...
Use the HTML files as iframe backgrounds or screenshot them. Keep the markdown text for slide captions, KPIs, and spotlight highlights.