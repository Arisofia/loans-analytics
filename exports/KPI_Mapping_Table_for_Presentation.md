Each KPI row below is drawn directly from the production analytics export (`exports/cascade/abaco_complete_analytics.json`, data_quality.last_updated **2025-12-03**). Every value reflects real operational data—no placeholders or examples.
